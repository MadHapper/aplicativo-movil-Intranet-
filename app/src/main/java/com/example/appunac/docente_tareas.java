...
public class docente_tareas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docente_tareas);
        ...
        guardarURLButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new docente_tareas.ModificarURLMeet().execute(cursoc, urlMeet);
            }
        });

        new docente_tareas.ObtenerURLMeet().execute(cursoc);
    }
    ...
    private class ObtenerURLMeet extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://www.productosjr.com/aplicativos/appunac/docentetareas.php?cursoc=" + cursoc);
        ...
        protected void onPostExecute(String resultado) {
            if (resultado != null) {
                try {
                    ...
                    String urlMeet = jsonResultado.getString("curso_tareas");
    ...
    private class ModificarURLMeet extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://www.productosjr.com/aplicativos/appunac/docentetareasModificar.php?cursoc=" + cursoc + "&urlMeet=" + urlMeet);
                urlConnection = (HttpURLConnection) url.openConnection();
        ...
        protected void onPostExecute(Boolean success) {
            if (success) {
                Toast.makeText(docente_tareas.this, "URL modificada exitosamente", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(docente_tareas.this, "Error al modificar la URL", Toast.LENGTH_SHORT).show();
            }
        }
    }
