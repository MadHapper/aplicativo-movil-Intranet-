...
public class Docente_Meet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docente_meet);
        ...
        guardarURLButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new ModificarURLMeet().execute(cursoc, urlMeet);
            }
        });

        new ObtenerURLMeet().execute(cursoc);
    }
    ...
    private class ObtenerURLMeet extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://www.productosjr.com/aplicativos/appunac/docenteMeet.php?cursoc=" + cursoc);
        ...
        protected void onPostExecute(String resultado) {
            if (resultado != null) {
                try {
                    ...
                    String urlMeet = jsonResultado.getString("curso_meet");
    ...
    private class ModificarURLMeet extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                URL url = new URL("https://www.productosjr.com/aplicativos/appunac/modificarURLMeet.php?cursoc=" + cursoc + "&urlMeet=" + urlMeet);
                urlConnection = (HttpURLConnection) url.openConnection();
        ...
        protected void onPostExecute(Boolean success) {
            if (success) {
                Toast.makeText(Docente_Meet.this, "URL modificada exitosamente", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(Docente_Meet.this, "Error al modificar la URL", Toast.LENGTH_SHORT).show();
            }
        }
    }
